...
# (historically the sign-in Frame.click); the marker routes the test into the
# retrying offload group. A genuine break still surfaces by failing every retry,
# as MIND-285's New Tab regression did.
@pytest.mark.flaky
