...
- Clicking a provider button now gives immediate feedback: a small spinner appears in front of that provider's logo and both provider buttons fade slightly while the browser round-trip runs.
