...
def render_overlay_host_page() -> str:
    ...
    (as kept-warm iframes) and hover tooltips -- is in-page DOM driven over IPC,
    so opening an overlay never costs a per-open page load. main.js loads this
    once at window creation and keeps it mounted for the window's life.
    """
