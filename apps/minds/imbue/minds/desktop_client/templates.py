...
_ICONS_16: Final[Mapping[str, str]] = {
    ...
    "panel": '<g fill="none" stroke="currentColor" stroke-width="1.2" stroke-linejoin="round"><rect x="2.1" y="2.6" width="11.8" height="10.8" rx="1.6"/><path d="M6.3 2.6v10.8"/></g>',
    "plug": '<g transform="scale(0.66667)" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22v-5"/><path d="M9 8V2"/><path d="M15 8V2"/><path d="M18 8v5a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4V8z"/></g>',
