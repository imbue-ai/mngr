...
def test_edge_to_edge_surfaces_opt_out_of_scrollbar_gutter() -> None:
    ...
    # Local pages are viewport-locked too and scroll inside the
    # local-page-scroll card (whose own stable gutter absorbs classic-scrollbar
    # layout shifts), so the document gutter is opted out everywhere and the
    # titlebar never shifts.
