...
// No event wiring -- these are visual only.
(function () {
  ...
  panel.appendChild(window.mindsSidebarRow.buildRow(samples[0], { isCurrent: true }));
  panel.appendChild(window.mindsSidebarRow.buildRow(samples[1], {}));
  panel.appendChild(window.mindsSidebarRow.buildRow(samples[2], {}));
})();
