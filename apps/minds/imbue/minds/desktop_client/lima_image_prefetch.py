...
def should_use_prebaked_lima_image(
    *,
    ...
    True only for the *default* workspace: a Lima create of the default DEFAULT_WORKSPACE_TEMPLATE repo
...
class LimaImageCreateGate(FrozenModel):
    ...
    default_repo_url: str = Field(description="Default default-workspace-template repo URL")
