...
See `service_dispatcher.py` in the system_interface (at `default-workspace-template/apps/system_interface/imbue/system_interface/`) for the service-side implementation.
