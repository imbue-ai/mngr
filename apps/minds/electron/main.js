...
ipcMain.on('show-workspace-context-menu', (event, agentId, x, y) => {
  ...
  // area (x: 0, y: 0). e.clientX / e.clientY from the WorkspaceRow
  // component's contextmenu handler are therefore already in window-content
  // coordinates, which is what menu.popup({ window, x, y }) expects -- no
  // offset needed.
