...
def build_payload(
    *, fct_link: str, fct_branch: str, name: str, ai_provider: str, anthropic_key: str, backup_provider: str
) -> dict:
    ...
    if on_stage is None and not quiet:
        print(
            ">> creating modal workspace {} from {}@{} ({}) ...".format(
                name or "<auto>", fct_link, fct_branch or "<default>", ai_provider
            ),
            flush=True,
        )
