...
#
# To trigger a fire on demand and read its JSON outcome (status / pr_url):
...
echo "(claude's final assistant message is a single JSON object: {status, pr_url}; failed runs add a notes field)"
