...
- Release tests do *not* run in CI. If you are developing or modifying release tests, CI will not verify them for you, so you must run them yourself locally (see the next bullet).
