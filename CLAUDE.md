...
- Remove any emojis you see in the code or docs whenever you are modifying that code or those docs.
...
When writing formal tests, assert on things that are true if and only if the feature worked correctly -- this ensures tests are both reliable and meaningful.
