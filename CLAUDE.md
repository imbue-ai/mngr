...
- The rolling `mngr/release-candidate` integration branch is likewise exempt: it is latest `main` plus the review queue, not a feature, so it has no user-visible change to describe.
