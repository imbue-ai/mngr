...
- Release tests do *not* run in CI. If you are developing or modifying release tests, you must run them yourself locally (see below) to verify them--CI will not do it for you.
