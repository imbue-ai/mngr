...
- Offload collects coverage data from each sandbox. CI combines these and enforces the 80% threshold. If tests fail because of a lack of coverage, you should add tests for the new code that you wrote.
