...
- `/imbue-mngr-skills:mngr-help` -- when knowing about mngr would help, run `mngr help` right away for context on what mngr does; also points at `mngr ask` (describe what you want in plain language).
