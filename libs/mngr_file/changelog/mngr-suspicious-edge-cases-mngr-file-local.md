...
- Added clarifying comments documenting intentionally-unreachable sentinel base paths and the conventional skipping of un-`lstat`-able directory entries (which silently omits permission-denied entries).
