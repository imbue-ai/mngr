...
from imbue.mngr_vps_docker.bare_realizer import BARE_HOST_STORE_DIR
from imbue.mngr_vps_docker.bare_realizer import BareRealizer
...
def _bare_realizer(temp_mngr_ctx: MngrContext, key_dir: Path) -> BareRealizer:
    return BareRealizer(
        config=VpsDockerProviderConfig(backend=ProviderBackendName("test-vps")),
...
_STUB_RECORD = VpsDockerHostRecord.model_construct(vps_ip="203.0.113.7")
