...
Usage:
    mngr mind-conversation-db insert <db_path> <conversation_id> <tags_json> <created_at>
    mngr mind-conversation-db lookup-model <db_path> <conversation_id>
    mngr mind-conversation-db lookup-by-name <db_path> <name>
    mngr mind-conversation-db count <db_path>
    mngr mind-conversation-db max-rowid <db_path>
    mngr mind-conversation-db poll-new <db_path> <max_rowid>
    mngr mind-conversation-db last-response-id <db_path> <conversation_id>
