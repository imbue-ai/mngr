...
The footer shows the most-used key bindings that fit the current width; press `?` for an overlay listing every binding (including your configured commands). `Esc` closes it.
