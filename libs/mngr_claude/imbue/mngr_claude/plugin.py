...
Finding this segment in an installPath means the plugin was installed inside a
previous mngr agent rather than in the user's persistent ~/.claude/ directory.
"""
