"""Unit tests for the mngr-mind-chat CLI module."""
...
from imbue.mngr_mind_chat.cli import ChatCliOptions
from imbue.mngr_mind_chat.cli import MIND_LABEL_KEY
from imbue.mngr_mind_chat.cli import MIND_LABEL_VALUE
from imbue.mngr_mind_chat.cli import _is_mind
from imbue.mngr_mind_chat.cli import _resolve_latest_conversation_args
from imbue.mngr_mind_chat.cli import chat
from imbue.mngr_mind_chat.cli import resolve_chat_args
from imbue.mngr_mind_chat.testing import TestAgent
from imbue.mngr_mind_chat.testing import create_conversation_events
...
def test_is_mind_returns_true_for_mind_label() -> None:
    assert _is_mind({MIND_LABEL_KEY: MIND_LABEL_VALUE}) is True


def test_is_mind_returns_false_for_missing_label() -> None:
    assert _is_mind({}) is False


def test_is_mind_returns_false_for_wrong_value() -> None:
    assert _is_mind({MIND_LABEL_KEY: "false"}) is False
