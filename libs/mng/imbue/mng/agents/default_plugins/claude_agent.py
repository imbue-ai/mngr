...
def _provision_background_scripts(host: OnlineHostInterface) -> None:
    ...
    stream_transcript.sh, and claude_background_tasks.sh so they can be
    ...
    for script_name in ("mng_log.sh", "export_transcript.sh", "stream_transcript.sh", "claude_background_tasks.sh"):
