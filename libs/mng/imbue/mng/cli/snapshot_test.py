...
# =============================================================================
# Snapshot group subcommand routing tests
# =============================================================================
...
def test_snapshot_bare_invocation_shows_help(
    ...
    """Running `mng snapshot` with no args should show help."""
...
def test_snapshot_unrecognized_subcommand_errors(
    ...
    """Running `mng snapshot nonexistent` should show 'No such command' error."""
