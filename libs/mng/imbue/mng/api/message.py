    ...
    try:
        ...
        for agent_ref in agent_refs:
            ...
            if compiled_include_filters or compiled_exclude_filters or not all_agents:
                agent_context = _agent_to_cel_context(agent, host_ref.provider_name, str(host_ref.host_name))
...
def _agent_to_cel_context(agent: AgentInterface, provider_name: str, host_name: str) -> dict[str, Any]:
