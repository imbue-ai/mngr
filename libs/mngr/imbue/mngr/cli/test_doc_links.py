"""Release tests: the GitHub doc URLs that imbue_mngr_doc_url builds actually resolve.

These hit github.com over the network (hence release-marked, kept out of the
fast suite). They guard the version-pinning ref policy in doc_links against
silent breakage -- a wrong tag format, or the repo being renamed/made private --
which would turn every terminal help-topic link into a dead 404.
"""
