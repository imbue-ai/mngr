...
| `--reintegrate` | boolean | Re-read outcomes from a previous TMR run (by --run-name), re-run the integrator, and regenerate the report. Skips test collection and agent launching. | `False` |
