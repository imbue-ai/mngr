...
Internal: the agent `wait_for_ready_signal` parameter `is_creating` was renamed to `is_tui_ready_awaited` (it gates whether the call waits for the TUI ready indicator). No behavior change.
