...
def test_modify_env_vars_exposes_agy_log_file_and_app_data_dir(antigravity_agent: AntigravityAgent) -> None:
    """The streamer needs the agy --log-file location and the per-agent app-data dir."""
