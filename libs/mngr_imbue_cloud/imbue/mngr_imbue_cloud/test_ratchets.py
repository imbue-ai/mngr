...
def test_prevent_builtin_exception_raises() -> None:
    # +1 for the region validation in parse_imbue_cloud_build_args, which raises
    # ValueError to match the rest of that parser's contract (the caller,
    # instance.create_host, catches ValueError and wraps it as MngrError).
