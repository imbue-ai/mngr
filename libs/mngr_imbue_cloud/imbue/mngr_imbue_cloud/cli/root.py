...
def imbue_cloud() -> None:
    """Imbue Cloud (auth, account plans/quotas, host leasing, machines, keys, buckets, shares, users, contacts)."""
...
imbue_cloud.add_command(users)
imbue_cloud.add_command(contacts)
